...
def test_explode():
    assert(find_and_explode(convert("[[[[[9,8],1],2],3],4]")) == "[[[[0,9],2],3],4]")
    assert(find_and_explode(convert("[7,[6,[5,[4,[3,2]]]]]")) == "[7,[6,[5,[7,0]]]]")
    assert(find_and_explode(convert("[[6,[5,[4,[3,2]]]],1]")) == "[[6,[5,[7,0]]],3]")
    assert(find_and_explode(convert("[[3,[2,[1,[7,3]]]],[6,[5,[4,[3,2]]]]]")) == "[[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]")
    assert(find_and_explode(convert("[[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]")) == "[[3,[2,[8,0]]],[9,[5,[7,0]]]]")
